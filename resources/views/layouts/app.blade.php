        ...
        <div class="w-64 h-screen overflow-y-auto bg-slate-900 text-white flex flex-col justify-between hidden md:flex shadow-2xl">
            <div>
                ...
                <nav class="flex-1 mt-6 px-4 pb-24 space-y-2 overflow-y-auto">
                    ...
                    <!-- Módulo Producción y Seguimiento Maquilas -->
                    @if((auth()->user()->hasPermission('gestionar_maquilas') || auth()->user()->hasRole(['admin', 'ADMIN', 'Administrador'])) && !auth()->user()->hasRole('Analista de Producción'))
                    <a href="{{ route('maquila.consultar') }}" class="block py-3 px-4 rounded transition flex items-center {{ request()->routeIs('maquila.consultar') ? 'bg-white/10 border-l-4 border-teal-400 text-white shadow-sm font-medium' : 'hover:bg-gray-800 hover:text-white text-gray-300' }}">
                        <svg class="w-5 h-5 mr-3 text-teal-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                        Consulta Maquilas 360°
                    </a>
                    <a href="{{ route('maquila.index') }}" class="block py-3 px-4 rounded transition flex items-center {{ request()->routeIs('maquila.index') ? 'bg-white/10 border-l-4 border-emerald-400 text-white shadow-sm font-medium' : 'hover:bg-gray-800 hover:text-white text-gray-300' }}">
                        <svg class="w-5 h-5 mr-3 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>
                        Gestión OPs Maquilas
                    </a>
                    @endif

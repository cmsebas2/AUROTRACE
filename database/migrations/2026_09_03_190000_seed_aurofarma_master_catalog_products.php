...
use App\Models\MaquilaCatalogItem;
use App\Models\Item;
...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        foreach ($byProduct as $pData) {
            // Unir nombres de presentaciones para el campo descriptivo
            ...
            // Crear presentaciones en product_presentations
        ...
        // 2. Poblar tabla maquila_catalog_items y tabla items para búsqueda instantánea
        foreach ($rawItems as $row) {
            $code = $row[0];
            $prodName = trim($row[1]);
            $presentation = trim($row[2]);
